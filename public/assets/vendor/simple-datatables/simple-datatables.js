                    ...
                    return r
                        ...
                        1: [function(require, module, exports) {
                                            ...
                                            (function() {
                                                            ...
                                                            ! function(t, e, s) {
                                                                ...
                                                                switch (e[s._const.action]) {
                                                                    ...
                                                                    case s._const.addElement:
                                                                        ...
                                                                        n = null === (i = x(t, d)) || void 0 === i ? void 0 : i.node, l = e[s._const.element], n.childNodes || (n.childNodes = []), u >= n.childNodes.length ? n.childNodes.push(l) : n.childNodes.splice(u, 0, l), n.subsets && n.subsets.forEach((function(t) {
                                                                    ...
                                                                    case s._const.addTextElement:
                                                                        ...
                                                                        (l = {}).nodeName = "#text", l.data = e[s._const.value], (n = x(t, d).node).childNodes || (n.childNodes = []), p >= n.childNodes.length ? n.childNodes.push(l) : n.childNodes.splice(p, 0, l), "TEXTAREA" === n.nodeName && (n.value = e[s._const.newValue]), n.subsets && n.subsets.forEach((function(t) {
                                                    ...
                                                    var $ = {
                                                        ...
                                                        L = function(t, e) {
                                                            ...
                                                            return t.replace(M, (function(r, l) {
                                                                if (o) {
                                                                ...
                                                                if (d) {
                                                                    s = C(r), n++, "tag" === s.type && e.components[s.node.nodeName] && (s.type = "component", o = !0), s.voidElement || o || !u || "<" === u || (s.node.childNodes || (s.node.childNodes = []), s.node.childNodes.push({
                                                                        nodeName: "#text",
                                                        ...
                                                        S = function() {
                                                            ...
                                                            return t.prototype.init = function() {
                                                                ...
                                                                do {
                                                                    ...
                                                                    0 === (s = this.findNextDiff(t, e, [])).length && (g(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0, f(t), s = this.findNextDiff(t, e, [])))), s.length > 0 && (this.foundAll = !1, this.tracker.add(s), N(t, s, this.options))
                                                                } while (s.length > 0);
                                                                ...
                                                                if (s.length && this.options.diffcap < Math.abs((t.childNodes || []).length - (e.childNodes || []).length)) return [(new y).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, m(t)).setValue(this.options._const.newValue, m(e)).setValue(this.options._const.route, s)];
                                                                ...
                                                                for (n = t.attributes ? Object.keys(t.attributes).sort() : [], a = e.attributes ? Object.keys(e.attributes).sort() : [], o = n.length, l = 0; l < o; l++) i = n[l], -1 === (r = a.indexOf(i)) ? d.push((new y).setValue(this.options._const.action, this.options._const.removeAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, t.attributes[i])) : (a.splice(r, 1), t.attributes[i] !== e.attributes[i] && d.push((new y).setValue(this.options._const.action, this.options._const.modifyAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.oldValue, t.attributes[i]).setValue(this.options._const.newValue, e.attributes[i])));
                                                                ...
                                                                for (var a, o, r, l, d, c, h = function(t, e, s) {
                                                                    ...
                                                                    }(t, e, s), u = h.gaps1, p = h.gaps2, f = Math.min(u.length, p.length), g = [], _ = 0, w = 0; _ < f; w += 1, _ += 1)
                                                                    if (!n || !0 !== u[_] && !0 !== p[_])
                                                                        if (!0 === u[_])
                                                                            if ("#text" === (l = t.childNodes[w]).nodeName)
                                                                                if ("#text" === e.childNodes[_].nodeName) {
                                                                                    if (l.data !== e.childNodes[_].data) {
                                                                                        ...
                                                                                        if (!d) return g.push((new y).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.oldValue, l.data).setValue(this.options._const.newValue, e.childNodes[_].data)), g
                                                                                    }
                                                                ...
                                                                else if (!0 === p[_]) "#text" === (l = e.childNodes[_]).nodeName ? (g.push((new y).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.value, l.data)), u.splice(_, 0, !0), f = Math.min(u.length, p.length), w -= 1) : (g.push((new y).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(_)).setValue(this.options._const.element, m(l))), u.splice(_, 0, !0), f = Math.min(u.length, p.length), w -= 1);
                                                                else if (u[_] !== p[_]) {
                                                                ...
                                                                var i = [];
                                                                return t.selected !== e.selected && i.push((new y).setValue(this.options._const.action, this.options._const.modifySelected).setValue(this.options._const.oldValue, t.selected).setValue(this.options._const.newValue, e.selected).setValue(this.options._const.route, s)), (t.value || e.value) && t.value !== e.value && "OPTION" !== t.nodeName && i.push((new y).setValue(this.options._const.action, this.options._const.modifyValue).setValue(this.options._const.oldValue, t.value || "").setValue(this.options._const.newValue, e.value || "").setValue(this.options._const.route, s)), t.checked !== e.checked && i.push((new y).setValue(this.options._const.action, this.options._const.modifyChecked).setValue(this.options._const.oldValue, t.checked).setValue(this.options._const.newValue, e.checked).setValue(this.options._const.route, s)), i
                                                            }, t
                                                        }(),
                                                        k = {
                                                            debug: !1,
                                                        ...
                                                        T = function() {
                                                            function t(t) {
                                                                if (void 0 === t && (t = {}), Object.entries(k).forEach((function(e) {
                                                                        var s = e[0],
                                                                            i = e[1];
                                                    ...
                                                    const B = (t, e) => {
                                                        ...
                                                        U = (t, e, s, n, a) => {
                                                            ...
                                                            t.headings ? o.headings = t.headings.map((t => z(t))) : e ? .tHead ? o.headings = Array.from(e.tHead.querySelectorAll("th")).map(((t, e) => {
                                                                const o = (t => {
                                                                    const e = D(t, {
                                                                        valueDiffing: !1
                                                                    });
                                                            ...
                                                            })) : t.data ? .length ? o.headings = t.data[0].map((t => z(""))) : e ? .tBodies.length && (o.headings = Array.from(e.tBodies[0].rows[0].cells).map((t => z(""))));
                                                    ...
                                                    class W {
                                                        ...
                                                        add(t) {
                                                            ...
                                                            if (this.dt.data.headings = this.dt.data.headings.concat([z(t.heading)]), this.dt.data.data = this.dt.data.data.map(((e, s) => e.concat([F(t.data[s], t)]))), this.settings[e] = {
                                                                    type: t.type || "string",
                                                                    sortable: !0,
                                                                    searchable: !0
                            ...
                            X = (t, e, s, i, n) => {
                                ...
                                if (n.firstLast && a.push(Z(1, n.firstText, n)), n.nextPrev) {
                                    const e = t ? 1 : s - 1;
                                    a.push(Z(e, n.prevText, n, {
                                        hidden: t
                                    }))
                                }
                                let o = [...Array(i).keys()].map((t => Z(t + 1, String(t + 1), n, {
                                    active: t === s - 1
                                })));
                        ...
                        class K {
                            ...
                            editCellModal() {
                                const t = this.data.cell,
                                    ...
                                    a = [`<div class='${this.options.classes.inner}'>`, `<div class='${this.options.classes.header}'>`, `<h4>${this.options.labels.editCell}</h4>`, `<button class='${this.options.classes.close}' type='button' data-editor-close>${this.options.labels.closeX}</button>`, " </div>", `<div class='${this.options.classes.block}'>`, `<form class='${this.options.classes.form}'>`, `<div class='${this.options.classes.row}'>`, `<label class='${this.options.classes.label}'>${n(i)}</label>`, `<input class='${this.options.classes.input}' value='${n(t.text||String(t.data)||"")}' type='text'>`, "</div>", `<div class='${this.options.classes.row}'>`, `<button class='${this.options.classes.save}' type='button' data-editor-save>${this.options.labels.save}</button>`, "</div>", "</form>", "</div>", "</div>"].join(""),
                                    o = s("div", {
                                ...
                                r.focus(), r.selectionStart = r.selectionEnd = r.value.length, o.addEventListener("click", (t => {
                                    ...
                                    if (e instanceof Element)
                                        if (e.hasAttribute("data-editor-close")) {
                                            ...
                                            this.closeModal()
                                        } else e.hasAttribute("data-editor-save") && (t.preventDefault(), this.saveCell(r.value))
                                }))
                            }
                            saveCell(t) {
                            ...
                            dismiss(t) {
                                ...
                                let s = !0;
                                this.options.contextMenu && this.editing && (s = !e.matches(`input.${this.options.classes.input}[type=text]`)), s && this.closeMenu()
                            }
                            openMenu() {
                                if (this.editing && this.data && this.editingCell) {
                                    const t = this.modalDOM ? this.modalDOM.querySelector(`input.${this.options.classes.input}[type=text]`) : this.dt.wrapperDOM.querySelector(`input.${this.options.classes.input}[type=text]`);
                        ...
                        exports.DataTable = class {
                            ...
                            init() {
                                ...
                                this._virtualDOM = D(this.dom, {
                                    valueDiffing: !1
                                }), this._tableAttributes = {
                                    ...this._virtualDOM.attributes
                                }, this.rows = new J(this), this.columns = new W(this), this.data = U(this.options.data, this.dom, this.columns.settings, this.options.type, this.options.format), this._render(), setTimeout((() => {
                            ...
                            _renderTable(t = {}) {
                                let e = P(this._tableAttributes, this.data.headings, (this.options.paging || this._searchQueries.length) && this._currentPage && this.pages.length && !t.noPaging ? this.pages[this._currentPage - 1] : this.data.data.map(((t, e) => ({
                                    row: t,
                                    index: e
