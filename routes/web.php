...
Route::get('/admin/data-periksa/data-imunisasi/cetak-pdf', [ImunisasiController::class, 'pdfExport'])->name('cetak_imunisasi');
...
Route::get('/admin/data-periksa/data-timbangan/cetak-pdf', [TimbanganController::class, 'pdfExport'])->name('cetak_timbangan');
...
Route::get('/admin/data-periksa/data-ibu-hamil/cetak-pdf', [IbuHamilController::class, 'pdfExport'])->name('cetak_ibu_hamil');
